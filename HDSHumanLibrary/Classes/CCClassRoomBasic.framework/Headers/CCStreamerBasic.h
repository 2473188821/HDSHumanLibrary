...
/*!
 * @method
 * @abstract 获取支持的推流分辨率(返回数据对应CCResolution枚举值)
 */
- (NSArray *)resolutionsSupport;
...
#pragma mark -- 修改用户音视频状态
/*!
@method
@abstract 确认是否可以修改用户对应状态
@param uid          用户id
@param open         对应状态打开/关闭
@param role         修改的人员角色
@param completion 结果
@return 操作结果
*/
- (BOOL)mediaSwitchAudioUserid:(NSString *)uid state:(BOOL)open role:(CCRole)role completion:(CCComletionBlock)completion;
